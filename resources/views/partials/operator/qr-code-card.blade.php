...
<div class="op-card">
    ...
    @if ($operator && $operator->qr_code)
        ...
        <div class="op-qr-actions">
            <a href="https://api.qrserver.com/v1/create-qr-code/?size=1000x1000&data={{ urlencode(route('rate.operator', $operator->qr_code)) }}" target="_blank" rel="noopener" class="tw-btn tw-btn-navy tw-btn-sm flex-1">
