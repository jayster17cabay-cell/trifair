...
<div class="tw-page-head">
    <div>
        <h1 class="tw-page-title">All Ratings & Feedback</h1>
...
<div class="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
    ...
    @endphp
    <div class="tw-stat">
        <div class="tw-stat-icon bg-blue-100 text-blue-600"><i class="bi bi-star"></i></div>
        <div class="tw-stat-num">{{ $totalR }}</div>
        <div class="tw-stat-label">Total</div>
    </div>
    <div class="tw-stat">
        <div class="tw-stat-icon bg-emerald-100 text-emerald-600"><i class="bi bi-hand-thumbs-up"></i></div>
        <div class="tw-stat-num">{{ $goodR }}</div>
        <div class="tw-stat-label">Good</div>
    </div>
    <div class="tw-stat">
        <div class="tw-stat-icon bg-red-100 text-red-600"><i class="bi bi-exclamation-circle"></i></div>
        <div class="tw-stat-num">{{ $pendingR }}</div>
        <div class="tw-stat-label">Pending</div>
    </div>
    <div class="tw-stat">
        <div class="tw-stat-icon bg-violet-100 text-violet-600"><i class="bi bi-paperclip"></i></div>
...
@forelse ($ratings as $rating)
    ...
    @endphp
    <div class="tw-card mb-3 {{ $rr <= 2 && !$rating->is_reviewed ? 'border-l-4 border-l-amber-400' : '' }}">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="flex flex-col gap-1.5">
                            @if ($rating->start_location)
                                <span class="inline-flex w-fit items-center gap-1.5 rounded-md border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-semibold text-slate-600">
