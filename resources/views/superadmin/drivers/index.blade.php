...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('superadmin.drivers.create') }}" class="btn btn-yellow">
                    ...
                    @forelse ($drivers as $driver)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('superadmin.drivers.qrcode', $driver) }}" class="btn btn-sm btn-outline-yellow" title="View QR Code">
                                    <i class="bi bi-qr-code"></i>
                                </a>
                            </td>
                            <td class="text-end">
                                <div class="d-inline-flex gap-1">
                                    <a href="{{ route('superadmin.drivers.edit', $driver) }}" class="btn btn-sm btn-outline-primary" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('superadmin.drivers.destroy', $driver) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this driver? This action cannot be undone.')">
                                        @csrf
                                        @method('DELETE')
