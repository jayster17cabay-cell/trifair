                ...
                @forelse ($ratings as $rating)
                    <tr class="tw-tr-hover">
                        ...
                        <td class="tw-td text-right">
                            <form action="{{ route('superadmin.ratings.restore', $rating) }}" method="POST" onsubmit="return confirm('Restore this rating? It will count towards the operator\'s average again.')">
                                @csrf
                                @method('PATCH')
