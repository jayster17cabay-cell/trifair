                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1" style="min-width: 0;">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <small class="text-muted" style="font-size: 0.78rem;">{{ $rating->created_at->diffForHumans() }}</small>
                                </div>
                                @if ($rating->start_location && $rating->end_location)
                                    <div style="font-size: 0.72rem; color: var(--gray-600); margin-top: 2px;">
                    ...
                    <div class="d-flex align-items-center gap-3 px-4 py-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex gap-1 mt-1">
                                @for ($i = 1; $i <= 5; $i++)
                                    <i class="bi bi-star-fill" style="color: {{ $i <= round($driver->valid_ratings_avg_rating ?? 0) ? 'var(--secondary)' : 'var(--gray-200)' }}; font-size: 0.7rem;"></i>
                                @endfor
                            </div>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="d-flex align-items-start gap-3 px-4 py-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                        ...
                        <div class="flex-grow-1" style="min-width: 0;">
                            ...
                            <div class="d-flex gap-1 mt-1">
                                @for ($i = 1; $i <= 5; $i++)
                                    @if ($i <= $rating->rating)
                                        <i class="bi bi-star-fill" style="color: var(--secondary); font-size: 0.7rem;"></i>
                                    @else
                                        <i class="bi bi-star" style="color: var(--gray-200); font-size: 0.7rem;"></i>
                                    @endif
                                @endfor
                            </div>
                            @if ($rating->start_location && $rating->end_location)
