...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0" style="font-size: 0.9rem;">Real-time overview of the TriFair system</p>
    </div>
    <div class="d-flex gap-2">
        <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill" style="font-size: 0.8rem;">
...
@if (isset($unreadCount) && $unreadCount > 0)
    <div class="alert alert-warning alert-banner d-flex align-items-center justify-content-between shadow-sm" role="alert">
        <div>
            ...
            <span class="ms-2" style="font-size: 0.9rem;">New complaints or updates require your attention.</span>
        </div>
    ...
    <div class="col-12">
        <div class="card card-accent-blue">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-diagram-3 me-2" style="color: var(--primary);"></i>Drivers by TODA</span>
...
<div class="row mt-4">
    <div class="col-md-4">
        <div class="card card-accent-yellow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-lightning-charge me-2" style="color: var(--secondary);"></i>Quick Actions</span>
            </div>
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.drivers.create') }}" class="btn btn-yellow text-start">
                        <i class="bi bi-person-plus me-2"></i> Add New Driver
                    </a>
                    <a href="{{ route('admin.drivers') }}" class="btn btn-outline-primary text-start">
                        <i class="bi bi-people me-2"></i> Manage Drivers
                    </a>
                    <a href="{{ route('admin.ratings') }}" class="btn btn-outline-yellow text-start">
                        <i class="bi bi-star me-2"></i> View All Ratings
                    </a>
                    <a href="{{ route('admin.reports') }}" class="btn btn-outline-yellow text-start">
                        <i class="bi bi-bar-chart me-2"></i> Performance Reports
                    </a>
                </div>
            </div>
        </div>
...
<div class="row mt-4">
    <div class="col-md-6">
        <div class="card card-accent-yellow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-trophy me-2" style="color: var(--secondary);"></i>Top Rated Drivers</span>
            </div>
            <div class="card-body p-0">
    ...
    <div class="col-md-6">
        <div class="card card-accent-yellow">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-clock-history me-2" style="color: var(--secondary);"></i>Recent Ratings</span>
                <a href="{{ route('admin.ratings') }}" class="btn btn-sm btn-outline-yellow">View All</a>
            </div>
            <div class="card-body p-0">
