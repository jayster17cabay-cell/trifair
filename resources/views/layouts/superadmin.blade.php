...
<body>
    <nav class="tw-topbar">
        <div class="flex items-center gap-3">
            ...
            <a class="tw-topbar-brand" href="{{ route('superadmin.dashboard') }}">
                <i class="bi bi-eye text-xl text-gold"></i>
                <span>TriFair <span class="text-gold">Superadmin</span></span>
            </a>
        </div>
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            <div class="relative">
                ...
                <div id="topMenu" data-tw-dropdown-menu class="tw-dropdown right-0 top-12 w-64">
                    ...
                    <a href="{{ route('superadmin.dashboard') }}" class="tw-dropdown-item"><i class="bi bi-speedometer2"></i> Dashboard</a>
                    <a href="{{ route('superadmin.officers') }}" class="tw-dropdown-item"><i class="bi bi-shield"></i> TFRB Officers</a>
                    <a href="{{ route('superadmin.operators') }}" class="tw-dropdown-item"><i class="bi bi-people"></i> Operators</a>
                    <a href="{{ route('superadmin.todas') }}" class="tw-dropdown-item"><i class="bi bi-diagram-3"></i> TODA</a>
                    <a href="{{ route('superadmin.ratings') }}" class="tw-dropdown-item"><i class="bi bi-star"></i> Ratings</a>
                    <a href="{{ route('superadmin.complaints') }}" class="tw-dropdown-item"><i class="bi bi-exclamation-triangle"></i> Complaints</a>
                    <a href="{{ route('superadmin.reports') }}" class="tw-dropdown-item"><i class="bi bi-bar-chart"></i> Reports</a>
                    <a href="{{ route('superadmin.activity-logs') }}" class="tw-dropdown-item"><i class="bi bi-clock-history"></i> Activity Logs</a>
    ...
    <div class="flex">
        ...
        <aside data-tw-sidebar class="tw-sidebar fixed left-0 top-0 z-50 -translate-x-full transition-transform duration-200 lg:sticky lg:top-0 lg:translate-x-0">
            <div class="mb-4 flex items-center justify-between border-b border-white/10 pb-4 lg:hidden">
                <span class="text-base font-extrabold text-white">TriFair <span class="text-gold">Superadmin</span></span>
            ...
            <nav class="space-y-1">
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.dashboard') ? 'active' : '' }}" href="{{ route('superadmin.dashboard') }}">
                    <i class="bi bi-speedometer2 w-5 text-center"></i> Dashboard
                </a>
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.officers*') ? 'active' : '' }}" href="{{ route('superadmin.officers') }}">
                    <i class="bi bi-shield w-5 text-center"></i> TFRB Officers
                </a>
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.complaints') ? 'active' : '' }}" href="{{ route('superadmin.complaints') }}">
            ...
            <nav class="space-y-1">
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.operators') ? 'active' : '' }}" href="{{ route('superadmin.operators') }}">
                    <i class="bi bi-people w-5 text-center"></i> Operators
                </a>
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.todas*') ? 'active' : '' }}" href="{{ route('superadmin.todas') }}">
                    <i class="bi bi-diagram-3 w-5 text-center"></i> TODA
                </a>
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.ratings*') ? 'active' : '' }}" href="{{ route('superadmin.ratings') }}">
                    <i class="bi bi-star w-5 text-center"></i> Ratings
                </a>
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.reports') ? 'active' : '' }}" href="{{ route('superadmin.reports') }}">
                    <i class="bi bi-bar-chart w-5 text-center"></i> Reports
                </a>
            </nav>

            <nav class="mt-1 space-y-1">
                <a class="tw-sidebar-link {{ request()->query('status') === 'pending' ? 'active' : '' }} border-l-2 border-gold" href="{{ route('superadmin.operators', ['status' => 'pending']) }}">
                    <i class="bi bi-hourglass-split w-5 text-center text-gold"></i> <strong>Pending Approvals</strong>
                </a>
            </nav>

            <div class="tw-sidebar-heading">Monitoring</div>
            <nav class="space-y-1">
                <a class="tw-sidebar-link {{ request()->routeIs('superadmin.activity-logs') ? 'active' : '' }}" href="{{ route('superadmin.activity-logs') }}">
